...
LAB10:    xsi_set_current_line(85, ng0);
    t2 = ieee_p_3499444699_sub_2213602152_3536714472(IEEE_P_3499444699, t17, 0, 9);
    t1 = (9U != 9U);
    if (t1 == 1)
        goto LAB30;
...
LAB30:    xsi_size_not_matching(9U, 9U, 0);
    goto LAB31;

LAB32:    xsi_size_not_matching(9U, 9U, 0);
    goto LAB33;

LAB34:    xsi_size_not_matching(9U, 9U, 0);
    goto LAB35;

LAB36:    xsi_size_not_matching(9U, 9U, 0);
    goto LAB37;

LAB38:    xsi_size_not_matching(9U, 9U, 0);
    goto LAB39;

LAB40:    xsi_size_not_matching(9U, 9U, 0);
    goto LAB41;

LAB42:    xsi_size_not_matching(9U, 9U, 0);
    goto LAB43;

LAB44:    xsi_size_not_matching(9U, 9U, 0);
    goto LAB45;
...
extern void work_a_0209865110_3212880686_init()
{
	...
	xsi_register_didat("work_a_0209865110_3212880686", "isim/mtb_isim_beh.exe.sim/work/a_0209865110_3212880686.didat");
